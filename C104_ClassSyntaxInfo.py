...
print(member_one.__class__)#will give whiche class <class '__main__.Member'>

my_dictionary = {
  'name': "Osama",
  'age': 36,
  'monthly_salary': 5000,
  'yearly_salary': ''  # Something we cant here do the calculation things thats why we use class oop
}
#print(my_dictionary['yearly_salary'])